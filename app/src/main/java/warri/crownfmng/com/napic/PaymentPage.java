...
public class PaymentPage extends AppCompatActivity {
    ...
    String backend_url = "https://napick.herokuapp.com/";
        ...
        mButtonPerformTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    PaymentPage.this.mTextError.setText(String.format("An error occurred while charging card: %s %s", e.getClass().getSimpleName(), e.getMessage()));
    ...
    private void startAFreshCharge(boolean local) {
        ...
        dialog = new ProgressDialog(PaymentPage.this);
    ...
    private void chargeCard() {
        ...
        PaystackSdk.chargeCard(PaymentPage.this, charge, new Paystack.TransactionCallback() {
            ...
            public void onSuccess(Transaction transaction) {
                ...
                PaymentPage.this.transaction = transaction;
                mTextError.setText(" ");
                Toast.makeText(PaymentPage.this, transaction.getReference(), Toast.LENGTH_LONG).show();
                updateTextViews();
            ...
            public void onError(Throwable error, Transaction transaction) {
                ...
                if (error instanceof ExpiredAccessCodeException) {
                    PaymentPage.this.startAFreshCharge(false);
                    PaymentPage.this.chargeCard();
                    return;
                }
                ...
                if (transaction.getReference() != null) {
                    Toast.makeText(PaymentPage.this, transaction.getReference() + " concluded with error: " + error.getMessage(), Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(PaymentPage.this, error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private class fetchAccessCodeFromServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                PaymentPage.this.mTextBackendMessage.setText(String.format("There was a problem getting a new access code form the backend: %s", error));
                dismissDialog();
            }
        }
    ...
    private class verifyOnServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            if (result != null) {
                PaymentPage.this.mTextBackendMessage.setText(String.format("Gateway response: %s", result));

            } else {
                PaymentPage.this.mTextBackendMessage.setText(String.format("There was a problem verifying %s on the backend: %s ", this.reference, error));
                dismissDialog();
            }
        }
