...
public class CustomersMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    private Button RequestKekeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DriverAvailableRef = FirebaseDatabase.getInstance().getReference().child("Keke Drivers Available");
        DriverLocationRef = FirebaseDatabase.getInstance().getReference().child("Drivers Working");

        CustomerLogoutButton = (Button) findViewById(R.id.customer_logout_btn);
        RequestKekeButton = (Button) findViewById(R.id.customers_request_keke_btn);
        ...
        RequestKekeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                ...
                RequestKekeButton.setText("Request Processing...");
                GetNearByKekeDriver();
    ...
    private void GetNearByKekeDriver()
    {
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                if (!driverFound)
                {
                    ...
                    RequestKekeButton.setText("Looking For Keke Location");
        ...
        DriverLocationRef.child(driverFoundID).child("l").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                {
                    ...
                    RequestKekeButton.setText("Driver Found");
                    ...
                    RequestKekeButton.setText("Driver Found..." + String.valueOf(Distance));
